...
custom_replacements = {
  ...
  */
  names = {
    ...
    connectivity_hub_vwan_resource_group_name      = "alz-connectivity"
    ...
    primary_hub_name                                   = "alz-hub-$${starter_location_01}"
    ...
    primary_firewall_policy_name                       = "alz-fw-hub-$${starter_location_01}-policy"
    ...
    secondary_hub_name                                   = "alz-hub-$${starter_location_02}"
    ...
    secondary_firewall_policy_name                       = "alz-fw-hub-$${starter_location_02}-policy"
    ...
    primary_hub_address_space                          = "10.100.0.0/22"
    primary_side_car_virtual_network_address_space     = "10.100.4.0/22"
    primary_bastion_subnet_address_prefix              = "10.100.4.0/26"
    primary_private_dns_resolver_subnet_address_prefix = "10.100.4.64/28"

    # IP Ranges Secondary
    # Regional Address Space: 10.101.0.0/16
    secondary_hub_address_space                          = "10.101.0.0/22"
    secondary_side_car_virtual_network_address_space     = "10.101.4.0/22"
    secondary_bastion_subnet_address_prefix              = "10.101.4.0/26"
    secondary_private_dns_resolver_subnet_address_prefix = "10.101.4.64/28"
  }
...
virtual_wan_settings = {
  name                = "alz-vwan-$${starter_location_01}"
