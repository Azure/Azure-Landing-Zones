...
the [Azure landing zone Library](https://github.com/Azure/Azure-Landing-Zones-Library) is a collection of assets that can be used to deploy Azure landing zone of different flavours.
...
The ALZ module uses the [Azure landing zone Library](https://github.com/Azure/Azure-Landing-Zones-Library) to resolve library references supplied to the provider.
...
These correspond to the releases in the [Azure landing zone Library](https://github.com/Azure/Azure-Landing-Zones-Library/releases).
...
The brains behind the Azure landing zone provider is a Go module called [`alzlib`](https://github.com/Azure/alzlib).
