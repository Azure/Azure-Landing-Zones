...
{{< hint type=note >}}
This documentation is specific to the **Bicep Classic** framework (`iac_type: bicep-classic`). For the new Azure Verified Modules framework, see [Bicep AVM - Complete]({{< relref "../bicep-platform-landing-zone" >}}).
{{< /hint >}}
