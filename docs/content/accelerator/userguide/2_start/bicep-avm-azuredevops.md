---
title: Azure DevOps with Bicep AVM
---

Follow these instructions to bootstrap Azure DevOps ready to deploy your platform landing zone with Bicep AVM (Azure Verified Modules).

{{< hint type=tip >}}
This is the **new Bicep AVM framework** (`iac_type: bicep-avm`) built on Azure Verified Modules. For the traditional framework, see [Azure DevOps with Classic Bicep]({{< relref "bicep-azuredevops" >}}).
{{< /hint >}}
...
1. Open your `inputs.yaml` file in Visual Studio Code (or your preferred editor) and copy the content from [inputs-azure-devops.yaml](https://raw.githubusercontent.com/Azure/alz-bicep-accelerator/refs/heads/main/examples/inputs-azure-devops.yaml) into that file.
