...
{{< hint type=tip >}}
This is the **new Bicep AVM framework** (`iac_type: bicep-avm`) built on Azure Verified Modules. For the traditional framework, see [Local File System with Classic Bicep]({{< relref "bicep-local" >}}).
{{< /hint >}}
