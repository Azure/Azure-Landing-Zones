...
Follow these instructions to bootstrap Azure DevOps ready to deploy your platform landing zone with Bicep Azure Verified Modules for Platform Landing Zone (ALZ).
