---
title: (Deprecated) Azure DevOps with Classic Bicep
weight: 110
---
...
{{< hint type=warning >}}
STOP! This documentation is specific to **Classic Bicep** (`iac_type: bicep-classic`). If you are using the accelerator for the first time, you should be using the Azure Verified Modules for Platform Landing Zone, see [Azure DevOps with Bicep AVM]({{< relref "bicep-azuredevops" >}}).
{{< /hint >}}
