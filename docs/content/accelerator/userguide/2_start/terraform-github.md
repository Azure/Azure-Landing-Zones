...
If you followed our [phase 0 planning and decisions]({{< relref "../0_planning">}}) guidance, you should have these values already.
    ...
    | `subscription_ids` | `TF_VAR` | `<management-subscription-id>, <identity-subscription-id>, <connectivity-subscription-id>, <connectivity-subscription-id>` | Replace `<xxxxxxxxxxx-subscription-id>` with the ids of the platform subscriptions you created in the previous phase. |
