...
Follow these instructions to bootstrap GitHub ready to deploy your platform landing zone with Bicep Bicep Azure Verified Modules for Platform Landing Zone (ALZ).
