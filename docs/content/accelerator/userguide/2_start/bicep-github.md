...
{{< hint type=tip >}}
This is the **new Bicep AVM framework** (`iac_type: bicep`) built on Azure Verified Modules. For the traditional framework, see [GitHub with Classic Bicep]({{< relref "bicep-classic-github" >}}).
{{< /hint >}}
