...
{{< hint type=note >}}
This documentation is specific to **Classic Bicep** (`iac_type: bicep-classic`). For the new Azure Verified Modules framework, see [GitHub with Bicep AVM]({{< relref "bicep-github" >}}).
{{< /hint >}}
